  ...
  return (
    <div className="min-h-screen bg-[#05070A] flex flex-col items-center justify-center font-sans relative">
      ...
      <div className="w-full max-w-md px-8 relative z-10">
        ...
        <p className="text-[#71717A] text-xs tracking-[0.2em] uppercase text-center mb-4 font-bold">
          Forge Admin Portal
        </p>
        <p className="text-[#52525B] text-[11px] text-center mb-12 border-b border-white/5 pb-6 leading-relaxed">
          Sign in once on this phone. Add to Home Screen — it opens the admin panel and stays
          logged in.
        </p>
        ...
        <form onSubmit={handleAuthentication} className="space-y-6">
          ...
          {error && (
            <div className="bg-red-950/30 border border-red-900/50 p-3 rounded-sm">
              <p className="text-[#EF4444] text-xs tracking-widest uppercase text-center font-semibold">
                {error}
              </p>
            </div>
          )}
